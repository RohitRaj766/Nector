...
export default function LocationPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <div className="px-6 pt-[100px] relative z-10 pb-8">
        <div className="flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center relative z-10">
            Select Your Location
          </h1>
          <p className="text-gray-500 text-base mb-8 text-center px-4 relative z-10">
